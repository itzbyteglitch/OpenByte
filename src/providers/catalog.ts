...
export const MODEL_CATALOG: ModelDefinition[] = [
  ...
  { provider: "nvidia-nim", id: "nvidia/nemotron-3-nano-30b-a3b", name: "NVIDIA NIM · Nemotron 3 Nano", protocol: "chat-completions", envKey: "NVIDIA_API_KEY", baseURL: "https://integrate.api.nvidia.com/v1" },
  { provider: "nvidia-nim", id: "nvidia/nemotron-3-super-120b-a12b", name: "NVIDIA NIM · Nemotron 3 Super", protocol: "chat-completions", envKey: "NVIDIA_API_KEY", baseURL: "https://integrate.api.nvidia.com/v1" },
  { provider: "nvidia-nim", id: "nvidia/llama-3.3-nemotron-super-49b-v1", name: "NVIDIA NIM · Nemotron Super 49B", protocol: "chat-completions", envKey: "NVIDIA_API_KEY", baseURL: "https://integrate.api.nvidia.com/v1" },
  ...
  { provider: "openrouter", id: "anthropic/claude-sonnet-4.6", name: "OpenRouter · Claude Sonnet 4.6", protocol: "chat-completions", envKey: "OPENROUTER_API_KEY", baseURL: "https://openrouter.ai/api/v1" },
  { provider: "openrouter", id: "google/gemini-3.1-pro-preview", name: "OpenRouter · Gemini 3.1 Pro", protocol: "chat-completions", envKey: "OPENROUTER_API_KEY", baseURL: "https://openrouter.ai/api/v1" },
